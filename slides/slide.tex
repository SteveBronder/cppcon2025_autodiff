...
struct var {
    ...
    auto val() const { return values_; }
    auto& adj() { return adjoints_; }
};
...
|{\mathcolor{yellow}{expr<Lambda<Plus>}}|, 
  |{\mathcolor{red}{expr<Lambda<Mult>}}|, 
   var, |{\mathcolor{cyan}{expr<Lambda<Log>}}|, var>>, 
  |{\mathcolor{magenta}{expr<Lambda<Mult>}}|, 
   |{\mathcolor{orange}{expr<Lambda<Log>}}|, 
    |{\mathcolor{lime}{expr<Lambda<Mult>}}|, var, var>>, var>>
\end{minted}
\end{frame}
...
\end{itemize}
\begin{figure}
\centerline{\includegraphics[scale=.05]{img/qr-code.png}}
\caption{Code and Slides}
\label{fig-qr-code}
\end{figure}
\end{frame}
